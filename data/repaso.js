  ...
  "5": {
    ...
    "Alemán: la casa y los muebles": [
      ...
      { q:"¿Qué significa <strong>das Bad</strong>?",
        ...
        exp:"Das Bad es el baño, donde los hobbits duschen. Es la única habitación de la casa que no acaba en -zimmer." },
      ...
      { q:"¿Cómo se dice <strong>el cuarto de baño</strong> en alemán?",
        opts:["das Bad","das Bett","der Balkon"], ans:0,
        exp:"Das Bad. Cuidado con das Bett, que se parece mucho pero es la cama." },
      ...
      { q:"¿Qué significa <strong>das Regal</strong>?",
        ...
        exp:"Das Regal es la estantería. Daniel dice que tiene meine Regale, en plural, porque tiene varias." },
      { q:"¿Qué significa <strong>das Bett</strong>?",
        opts:["La cama","La lámpara","El cuadro"], ans:0,
        exp:"Das Bett es la cama. Los tres niños del libro la nombran: es lo único que tienen todos." },
      ...
      { q:"¿Qué significa <strong>der Teppich</strong>?",
        ...
        exp:"Der Teppich es la alfombra. Anna tiene uno y dice que es schön bunt." },
      ...
      // --- Los textos de Ben, Daniel y Anna -------------------------------
      { q:"¿Quién comparte su habitación con su hermano pequeño?",
        opts:["Ben","Daniel","Anna"], ans:0,
        exp:"Ben: ich teile mein Zimmer mit Tim, das ist mein kleiner Bruder." },
      { q:"¿Cómo se llama el hermano pequeño de Ben?",
        opts:["Tim","Daniel","Ben"], ans:0,
        exp:"Tim. Ben cuenta que él también tiene ein Bett y muchos Spielsachen, juguetes." },
      { q:"¿Quién dice que su habitación es bastante oscura?",
        opts:["Daniel","Ben","Anna"], ans:0,
        exp:"Daniel: mein Zimmer ist ziemlich dunkel. Por eso pide una Leselampe." },
      { q:"¿Qué le hace falta todavía a Daniel?",
        opts:["Una lámpara para leer","Un ordenador","Una silla"], ans:0,
        exp:"Ich brauche noch eine Leselampe: le falta una lámpara para leer." },
      { q:"¿Dónde tiene Daniel sus dibujos?",
        opts:["Colgados en la pared","Encima de la mesa","Dentro del armario"], ans:0,
        exp:"Meine Bilder hängen an der Wand: sus cuadros cuelgan de la pared." },
      { q:"¿Quién tiene una alfombra de colores?",
        opts:["Anna","Ben","Daniel"], ans:0,
        exp:"Anna: ich habe einen Teppich, der ist schön bunt." },
      { q:"¿Qué tiene Anna encima de la mesa?",
        opts:["Sus lápices y una lámpara","Sus libros","Su ordenador"], ans:0,
        exp:"Auf dem Tisch sind meine Stifte und eine Lampe." },
      { q:"¿Qué hace Ben con el ordenador?",
        opts:["Jugar y escuchar música","Pintar","Leer"], ans:0,
        exp:"Ich spiele gern am Computer und höre Musik." },
      { q:"¿Quién dice que su habitación es grande y bonita?",
        opts:["Anna","Ben","Daniel"], ans:0,
        exp:"Anna: mein Zimmer ist groß und schön. Ben dice que el suyo es nicht sehr groß, aber hell." },
      { q:"¿De quién es la habitación donde solo hay una cama, una mesa y estanterías?",
        opts:["De Daniel","De Ben","De Anna"], ans:0,
        exp:"Daniel: da sind nur mein Bett und mein Tisch. Und meine Regale." },
